...
RUN apk add --update tzdata bash nano build-base python3-dev libxml2-dev libxslt-dev unzip postgresql postgresql-dev libffi-dev libc-dev jpeg-dev zlib-dev
